...
• Executed code could get blocked or manipulated by the client]],
    ...
    ["indicator_fatalmenu"] = "Player has used the cheat 'FatalMenu' in the past or is currently doing so",
    ["indicator_imgui"] = "Player has imgui.ini file in their Garry's Mod folder. Used by many external cheats to store settings.",
    ["indicator_imgui_active"] = "Player has imgui.ini file in their Garry's Mod folder that was created after their game launched. Used by many external cheats to store settings.",
