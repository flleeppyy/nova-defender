...
• Executed code could get blocked or manipulated by the client]],
    ...
    ["indicator_imgui"] = "Player has imgui.ini file in his Garry's Mod folder. Used by many external cheats to store settings.",
    ["indicator_imgui_active"] = "Player has imgui.ini file in his Garry's Mod folder that was created after his game launched. Used by many external cheats to store settings.",
